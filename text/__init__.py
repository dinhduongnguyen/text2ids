...
import re
from cleaners import vn_cleaners
from symbols import phonemes
from vi_cleaner import cleaner
...
def text_to_sequence(text):
  ...
  '''
    ...
    while len(text):
        ...
        if not m:
            sequence += _symbols_to_sequence(robust_cleaner(text))
            break
...
def basic_cleaner(text, cleaner_name):
